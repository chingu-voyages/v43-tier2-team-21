...
const Hero = () => {
  return (
    <section className="flex items-center flex-col h-screen text-white bg-purple-600 py-40">
      <img src={heroImage} alt="" className="w-48 lg:w-56" />
      <h1 className="text-4xl lg:text-6xl pt-20 font-bold">Skill Tracker</h1>
      <h2 className="text-lg lg:text-2xl px-10">Start Learning Something New Today!</h2>
